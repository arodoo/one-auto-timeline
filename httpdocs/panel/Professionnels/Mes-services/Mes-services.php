...
?>
    ...
    $(document).ready(function() {
      ...
      $(document).on("click", "#bouton", function(e) {
       ...
       /*  console.log("Datos enviados al backend:", Object.fromEntries(formData.entries())); */
        $.post({
          url: '/panel/Professionnels/Mes-services/Mes-services-action-ajouter-modifier-ajax.php',
          type: 'POST',
          data: formData,
          processData: false,
          contentType: false,
      ...
      $(document).on("click", ".lien-supprimer", function() {
        ...
        $.ajax({
          url: '/panel/Professionnels/Mes-services/Mes-services-action-supprimer-ajax.php',
          type: 'POST',
          data: {
            idaction: idaction
          },
      ...
      function liste() {
        $.post({
          url: '/panel/Professionnels/Mes-services/Mes-services-liste-ajax.php',
          type: 'POST',
          dataType: "html",
          success: function(res) {
            $("#liste").html(res);
                ...
                ready: function() {
                  ...
                  cropButton.on('click', function(event) {
                    ...
                    canvas.toBlob(function(blob) {
                      ...
                      $.ajax({
                        url: '/panel/Professionnels/Mes-services/Mes-services-upload.php',
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
  ...
  <div style='padding: 5px; text-align: center;'>
    ...
    ?>
      <a href="/Mes-services/ajouter" class="btn btn-primary" style="float: right;  margin-right: 5px; margin-bottom: 20px;">Ajouter un service</a>
      <?php
    }
    ...
    if ($action == "ajouter" || $action == "modifier") {
      ...
      if ($action == "modifier") {
        ...
        ///////////////////////////////SELECT
        $req_select = $bdd->prepare("SELECT * FROM membres_services WHERE id=? AND id_membre=?");
      ...
      ?>
        ...
        <div align='left'>
          ...
          <a href="/Mes-services" class="btn btn-primary" style="float: right;">Liste</a>
          <a href="/Mes-services/ajouter" class="btn btn-primary" style="float: right;  margin-right: 5px;">Ajouter un service</a>
        </div><br />
        ...
        $sql = "SELECT numero, nom_image FROM membres_services_images WHERE id_membre = ? AND id_annonce_service = ?";
            ...
            <div class="row mb-3">
              <div class="col-md-6 text-left">
                ...
                <select name="id_categorie" id="id_categorie" class="form-control selectpicker" data-live-search="true">
                    ...
                    <?php
                    $query = $bdd->query("SELECT id, nom_categorie FROM configurations_categories WHERE type = 'service' AND activer = 'oui' ORDER BY nom_categorie ASC");
