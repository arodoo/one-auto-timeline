...
?>
    ...
    <script>
      $(document).ready(function() {
        ...
        $(document).on("click", "#bouton", function(e) {
          ...
          $.post({
            url: '/panel/Professionnels/Mes-annonces/Mes-annonces-action-ajouter-modifier-ajax.php',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
        ...
        $(document).on("click", ".lien-supprimer", function() {
          ...
          $.ajax({
            url: '/panel/Professionnels/Mes-annonces/Mes-annonces-action-supprimer-ajax.php',
            type: 'POST',
            data: {
              idaction: idaction
            },
           ...
           /*  error: function(jqXHR, textStatus, errorThrown) {
              ...
              alert('Erreur lors de la soumission du formulaire: ' + textStatus + ' - ' + errorThrown);
            } */
          });
        });
        ...
        function liste() {
          $.post({
            url: '/panel/Professionnels/Mes-annonces/Mes-annonces-liste-ajax.php',
            type: 'POST',
            dataType: "html",
            success: function(res) {
              $("#liste").html(res);
                  ...
                  ready: function() {
                    ...
                    cropButton.on('click', function(event) {
                      ...
                      canvas.toBlob(function(blob) {
                        ...
                        $.ajax({
                          url: '/panel/Professionnels/Mes-annonces/Mes-annonces-upload.php',
                          type: 'POST',
                          data: formData,
                          processData: false,
                          contentType: false,
    ...
    <div class="mes-annonces" style='padding: 5px; text-align: center;'>

      <?php
      if ($action != "ajouter" && $action != "modifier") {
      ?>
        <a href="/Mes-annonces/ajouter" class="btn btn-primary" style="float: right;  margin-right: 5px; margin-bottom: 20px;">Ajouter une annonce</a>
        <?php
      }
      ...
      /*     var_dump($id_departement_selected); */
        ?>

          <div align='left'>
            <h2 style="float: left;">Modifier</h2>
            <a href="/Mes-annonces" class="btn btn-primary" style="float: right;">Liste</a>
            <a href="/Mes-annonces/ajouter" class="btn btn-primary" style="float: right;  margin-right: 5px;">Ajouter une annonce</a>
          </div><br />
          ...
          $sql = "SELECT numero, nom_image FROM membres_annonces_images WHERE id_membre = ? AND id_annonce_service = ?";
            ...
            <div class="container mt-5 text-left" style="text-align: left;">
              ...
              <div class="row mb-3">
                <div class="col-md-6 text-left">
                  ...
                  <select name="id_categorie" id="id_categorie" class="form-control selectpicker" data-live-search="true">
                    <option value=''>Sélection</option>
                    <?php
                    $query = $bdd->query("SELECT id, nom_categorie FROM configurations_categories WHERE type = 'annonce' AND activer = 'oui' ORDER BY nom_categorie ASC");
                    while ($categorie = $query->fetch()) {
                      /*   $selected = ($categorie['id'] == $ligne_select_produit['id_categorie']) ? 'selected' : ''; */
                      $selected = ($categorie['id'] == $ligne_select['id_categorie']) ? 'selected' : '';
                      echo '<option value="' . $categorie['id'] . '" ' . $selected . '>' . $categorie['nom_categorie'] . '</option>';
                    }
                    ?>
                  </select>
                </div>
                ...
                <div class="col-md-12 text-left">
                  ...
                  <textarea name="description" id="description" class="form-control"><?php echo nl2br($ligne_select['description']); ?></textarea>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-md-4 text-left">
                  <label for="ville">*Ville:</label>
                  <input type="text" name="ville" id="ville" class="form-control" value="<?php echo $ligne_select['ville']; ?>">
                </div>
                <div class="col-md-4 text-left">
                ...
                <div class="col-md-4 text-left">
                  ...
                  <input type="text" name="specialite" id="specialite" class="form-control" value="<?php echo $ligne_select['specialite']; ?>">
                </div>
                <div class="col-md-4 text-left">
                ...
                <div class="col-md-4 text-left">
                  ...
                  <input type="text" name="mot_cle_1" id="mot_cle_1" class="form-control" value="<?php echo $ligne_select['mot_cle_1']; ?>">
                </div>
                <div class="col-md-4 text-left">
                  <label for="mot_cle_2">Mot clé 1:</label>
                  <input type="text" name="mot_cle_2" id="mot_cle_2" class="form-control" value="<?php echo $ligne_select['mot_cle_2']; ?>">
                </div>
                <div class="col-md-4 text-left">
                  <label for="mot_cle_1">Mot clé 3:</label>
                  <input type="text" name="mot_cle_3" id="mot_cle_3" class="form-control" value="<?php echo $ligne_select['mot_cle_3']; ?>">
                </div>
                <div class="col-md-4 text-left">
                  <label for="mot_cle_4">Mot clé 1:</label>
                  <input type="text" name="mot_cle_4" id="mot_cle_4" class="form-control" value="<?php echo $ligne_select['mot_cle_4']; ?>">
                </div>
                <div class="col-md-4 text-left">
                  <label for="mot_cle_1">Mot clé 5:</label>
                  <input type="text" name="mot_cle_5" id="mot_cle_5" class="form-control" value="<?php echo $ligne_select['mot_cle_5']; ?>">
                </div>
              </div>
              <div class="col-md-4 text-left">
...
<?php
      ...
      echo "<div class='alert alert-danger'>Vous devez être abonné pour pouvoir accéder à cette fonctionnalité et pouvoir déposer des annonces. <a href='/Abonnement' target='_blank'>Abonnez-vous ici</a></div>";
    }
  } else {
    header('location: /');
  }
