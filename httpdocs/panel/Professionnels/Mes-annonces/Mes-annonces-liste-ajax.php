...
// Create a URL-friendly slug from the announcement name - moved outside the loop
      ...
      ?>
        <tr class='odd'>
          <td class='dtr-control' style='text-align: center;'>
            <a href="/Page-annonce/<?php echo $title_slug; ?>/<?php echo $idoneinfos; ?>" target="_blank"><?php echo $ligne_boucle['nom']; ?></a>
          </td>
