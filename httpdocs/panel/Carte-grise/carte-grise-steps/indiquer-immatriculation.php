...
<div id="matriculation-container" class="content step">
    <div class="row">
            ...
            <div class="immatriculation-container">
                <div class="immatriculation-plaqueVerifContainer">
                                    ...
                                    <div class="immatriculation-inputContainer">
                                        <div class="immatriculation-inputContent">
                                            <input spellcheck="false" autocorrect="off" autocomplete="off"
                                                class="immatriculation-elemInp" type="text" id="w0qu4tsdwg"
                    ...
                    <div class="immatriculation-step-cta-container">
                        <button class="btn cta1" id="nextStepButton">Suivant</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="module">
    ...
    document.getElementById('w0qu4tsdwg').addEventListener('input', function (e) {
    ...
    document.getElementById('nextStepButton').addEventListener('click', function () {
        var immatriculation = document.getElementById('w0qu4tsdwg').value;
        ...
        if (currentProcess === 'changement de domicile' || currentProcess === 'declaration de session') {
            $('#iimtns').load('/panel/Carte-grise/carte-grise-steps/concerne-situations-dessous.php');
        } else {
            $('#iimtns').load('/panel/Carte-grise/carte-grise-steps/completer-vehicule-information.php');
        }
    });

    $(document).on('DOMNodeRemoved', '.immatriculation-container', function () {
        $('#iimtns').empty();
    });
