...
if (!empty($_SESSION['4M8e7M5b1R2e8s']) && !empty($user)) {
  ...
  $nom_fichier = "Mes-produits";
  $nom_fichier_datatable = "Mes-produits-" . date('d-m-Y', time()) . "-$nomsiteweb";
?>
  <script>
  ...
  <table id='Tableau_7' class='display' style='text-align: center; width: 100%; margin-top: 15px;' cellpadding='2' cellspacing='2'>
    ...
    <tfoot>
      <tr>
        ...
        <th class='search_table' style='text-align: center;'>OFFRE</th>
    ...
    <tbody>
      <?php
      // Boucle de sélection
      $req_boucle = $bdd->prepare("SELECT * FROM membres_produits WHERE id_membre=? ORDER BY id DESC");
      ...
      ?>
        <tr class='odd'>
          <td class='dtr-control' style='text-align: center;'></td>
          <td class='dtr-control' style='text-align: center;'><a href="/<?php echo $ligne_boucle['lien_produit']; ?>" target="blank_"><?php echo $ligne_boucle['nom_produit']; ?></a></td>
          ...
          <td style='text-align: center; width: 90px;'><?php echo $ligne_boucle['montant_unite']; ?>€</td>
          <td style='text-align: center; width: 90px;'>
            <?php echo "<a href='/Mes-produits/modifier/" . $idoneinfos . "' title='Modifier'><span class='uk-icon-file-text'></span></a>"; ?>
