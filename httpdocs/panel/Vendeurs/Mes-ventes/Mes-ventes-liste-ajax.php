...
$nom_fichier = "Mes-ventes";
$nom_fichier_datatable = "Mes-ventes-".date('d-m-Y', time())."-$nomsiteweb"; 
?>
<script>
...
<?php
// Boucle de sélection
$req_boucle = $bdd->prepare("SELECT * FROM membres_commandes WHERE id_membre=? ORDER BY id DESC");
...
?>
<tr class='odd'>
<td class='dtr-control' style='text-align: center;'><?php echo $ligne_select_clients['prenom']; ?> <?php echo $ligne_select_clients['nom']; ?> <?php echo " $nom_pro"; ?> </td>
...
<a href='#' class='btn-envoyer-message' data-id='<?php echo $ligne_select_clients['id']; ?>' data-nom='<?php echo $ligne_select_clients['nom']; ?>' onclick='return false;'>
