  ...
  <script>
    $(document).ready(function () {
      ...
      $(document).on("click", "#bouton", function () {
        ...
        tinyMCE.triggerSave();
        $.post({
          url: '/panel/Utilisateurs/Mes-commandes/Mes-commandes-action-ajouter-modifier-ajax.php',
          type: 'POST',
      ...
      $(document).on("click", ".lien-supprimer", function () {
        $.post({
          url: '/panel/Utilisateurs/Mes-commandes/Mes-commandes-action-supprimer-ajax.php',
          type: 'POST',
          data: {
      ...
      function liste() {
        $.post({
          url: '/panel/Utilisateurs/Mes-commandes/Mes-commandes-liste-ajax.php',
          type: 'POST',
          dataType: "html",
          success: function (res) {
            $("#liste").html(res);
  ...
  <div style='padding: 5px; text-align: center;'>
    ...
    if ($action == "ajouter" || $action == "modifier") {
      ...
      if ($action == "modifier") {
        ...
        ///////////////////////////////SELECT
        $req_select = $bdd->prepare("SELECT * FROM membres_commandes WHERE id=? AND id_membre_client=?");
	...
	$req_select_vendeur->execute(array($ligne_select['id_membre']));
	...
	$req_select_produit->closeCursor();
        ...
        <div align='left'>
          <h2 style="float: left;" >Visualiser</h2>
	    <a href="/Mes-commandes" class="btn btn-primary" style="float: right;" >Liste</a>
        </div><br />
...
<p><?php echo $ligne_select_vendeur['nom']; ?></p>
</div>
<div class="col-md-6 text-left">
<label for="prenom">Prénom:</label>
<p><?php echo $ligne_select_vendeur['prenom']; ?></p>
</div>
</div>
<div class="row mb-3">
<div class="col-md-6 text-left">
<label for="mail">Email:</label>
<p><?php echo $ligne_select_vendeur['mail']; ?></p>
</div>
<div class="col-md-6 text-left">
<label for="telephone">Téléphone:</label>
<p><?php echo $ligne_select_vendeur['Telephone_portable']; ?></p>
</div>
</div>
<div class="row mb-3">
<div class="col-md-6 text-left">
<label for="ville">Ville:</label>
<p><?php echo $ligne_select_vendeur['ville']; ?></p>
</div>
<div class="col-md-6 text-left">
<label for="cp">Code Postal:</label>
<p><?php echo $ligne_select_vendeur['cp']; ?></p>
</div>
</div>
<div class="row mb-3">
<div class="col-md-12 text-left">
<a href='#' class='btn btn-success btn-envoyer-message' data-id='<?php echo $ligne_select_vendeur['id']; ?>' data-nom='<?php echo $ligne_select_vendeur['nom']; ?>' onclick='return false;'>Envoyer un message</a>
</div>
</div>
</div>
