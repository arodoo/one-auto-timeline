...
$nom_fichier = "Paiements";
$nom_fichier_datatable = "Paiements-".date('d-m-Y', time())."-$nomsiteweb"; 
?>
<script>
...
<?php
// Boucle de sélection
$req_boucle = $bdd->prepare("SELECT * FROM membres_paiements_marketplace WHERE id_membre=? ORDER BY id DESC");
...
$req_select_vendeur->execute(array($ligne_boucle['id_membre_vendeur']));
