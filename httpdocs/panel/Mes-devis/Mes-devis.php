...
if (!empty($_GET['page'])) {
  ...
  switch ($_GET['page']) {
    ...
    case "Abonnement":
      include("pages/Abonnement/Abonnement.php");
      break;
    ...
    case "Traitements-admin":
      ...
      break;
    case "Success":
      include("pages/paiements/Panier/Panier-succeed.php");
      break;
    ...
    //panel / Annonces
    case "Annonces":
      include("pages/Annonces/Annonces.php");
      break;
    case "Page-annonce":
      include("pages/Annonces/Page-annonce.php");
      break;
    ...
    case "Services":
      ...
      break;
    case "Page-service":
      include("pages/Services/Page-service.php");
      break;
    /* case "Page-service-ct":include ("pages/Services/Services-et-catgories.php");break; */

    //panel / Marketplace
    case "Marketplace":
      include("pages/Marketplace/Marketplace.php");
      break;
    case "Page-marketplace":
      include("pages/Marketplace/Page-marketplace.php");
      break;

    //panel / Centres-controles-techniques
    case "Centres-controles-techniques":
      include("pages/Centres-controles-techniques/Centres-controles-techniques.php");
      break;
    case "Page-centre-controle-technique":
      include("pages/Centres-controles-techniques/Page-centre-controle-technique.php");
      break;
    ...
    //panel / Liste-avatar
    case "Liste-avatar":
      include("panel/Liste-avatar/Liste-avatar.php");
      break;

    //panel / Profil-professionnel
    case "Profil-professionnel":
      include("panel/Profil-professionnel/Profil-professionnel.php");
      break;

    //panel / Professionnels / Mes-annonces
    case "Mes-annonces":
      include("panel/Professionnels/Mes-annonces/Mes-annonces.php");
      break;
    //panel / Professionnels / Mes-annonces-ct
    case "Mes-annonces-ct":
      include("panel/Professionnels/Mes-annonces-ct/Mes-annonces-ct.php");
      break;
    //panel / Professionnels / Mes-services
    case "Mes-services":
      include("panel/Professionnels/Mes-services/Mes-services.php");
      break;


    //panel / Vendeurs 
    case "Mon-profil-vendeur":
      include("panel/Vendeurs/Mon-profil-vendeur/Mon-profil-vendeur.php");
      break;
    case "Mon-profil-vendeur-return":
      include("panel/Vendeurs/Mon-profil-vendeur/onboarding-return-handler.php");
      break;
    case "Mes-produits":
      include("panel/Vendeurs/Mes-produits/Mes-produits.php");
      break;
    case "Mes-ventes":
      include("panel/Vendeurs/Mes-ventes/Mes-ventes.php");
      break;
    case "Mes-paiements":
      include("panel/Vendeurs/Mes-paiements/Mes-paiements.php");
      break;

    //panel / Utilisateurs 
    case "Mes-annonces-client":
      include("panel/Utilisateurs/Mes-annonces-client/Mes-annonces-client.php");
      break;
    case "Mes-produits-favoris":
      include("panel/Utilisateurs/Mes-produits-favoris/Mes-produits-favoris.php");
      break;
    case "Mes-commandes":
      include("panel/Utilisateurs/Mes-commandes/Mes-commandes.php");
      break;
    case "Paiements":
      include("panel/Utilisateurs/Paiements/Paiements.php");
      break;
    ...
    case "modifier-profil-photo":
      include("panel/Avatar/Avatar-profil-photo.php");
      break;

    //panel / Profil-automobile
    case "Profil-automobile":
      include("panel/Profil-automobile/index.php");
      break;


    //panel / Mes-devis
    case "Mes-devis":
      include("panel/Mes-devis/Mes-devis.php");
      break;
    ...
    //panel / Carte-grise
    case "Carte-grise":
      include("panel/Carte-grise/Carte-grise.php");
      break;
    ...
    //panel / Constats
    case "Constats":
      include("panel/Constats/Constats.php");
      break;
    case "Constats-clients":
      include("panel/Constats/constats-client.php");
      break;
    case "Constat-amiable-accident":
      include("panel/Constats/constant-form/index-file-etape.php");
      break;
    case "Constats-pdf":
      include("panel/Constats/constant-form/PDFGenerator/index.php");
      break;
